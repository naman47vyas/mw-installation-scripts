...
# Function to setup YUM repository
setup_repo() {
...
#This curl gets the RPM file, we'll need to have some logic like old yum repo to get the required rpm file based on the $MW_DETECTED_ARCH and the $MW_VERSION
